%% run_RF_canales.m
% Runner: Random Forest canal a canal (19 canales).
% Requiere que EEG_DementiaClassifier.m haya sido ejecutado antes.

disp('========================================')
disp(' RANDOM FOREST — ANÁLISIS CANAL A CANAL')
disp('========================================')

% ---- Inicializar resultados ----
accuracy_all   = zeros(num_canales, 1);
recall_all     = zeros(num_canales, 3);
...
if guardar_resultados
    T = table((1:num_canales)', string(nombres_canales'), accuracy_all, ...
        ...
        'VariableNames', {'Canal','Nombre','Accuracy', ...
                          ...
                          'F1_AD','F1_C','F1_FTD'});
    nombre_archivo = sprintf('res_RF_canales_%s_rng1.xlsx', modalidad);
