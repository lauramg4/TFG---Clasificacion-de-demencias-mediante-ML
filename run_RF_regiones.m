%% run_RF_regiones.m
% Runner: Random Forest por regiones cerebrales (5 regiones).
% Requiere que EEG_DementiaClassifier.m haya sido ejecutado antes.

disp('========================================')
disp(' RANDOM FOREST — ANÁLISIS POR REGIONES')
disp('========================================')
...
if guardar_resultados
    T = table(string(regiones(:,1)), accuracy_all, ...
        ...
        'VariableNames', {'Region','Accuracy', ...
                          ...
                          'F1_AD','F1_C','F1_FTD'});
    nombre_archivo = sprintf('res_RF_regiones_%s_rng1.xlsx', modalidad);
